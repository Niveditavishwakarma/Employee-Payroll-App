...
import java.util.List;
    ...
    public class EmployeePayrollController {
        ...
        @PostMapping("/add")
        public ResponseEntity<EmployeePayrollData> addEmployee(@RequestBody EmployeePayrollData employee) {
            return new ResponseEntity<>(employeeService.addEmployee(employee), HttpStatus.CREATED);
        }

        @PutMapping("/update/{id}")
        public ResponseEntity<EmployeePayrollData> updateEmployee(@PathVariable int id, @RequestBody EmployeePayrollData updatedEmployee) {
